...
# 读取数据
df = pd.read_csv('c:\\Users\\Administrator\\WorkBuddy\\20260406101358\\sh_index_2015.csv')
...
ax1.annotate(f'最高点: {df.loc[max_idx, "收盘"]:.0f}', 
...
ax1.annotate(f'最低点: {df.loc[min_idx, "收盘"]:.0f}', 
...
# 标注关键事件
events = [
    ('2015-01-19', 3116, '119暴跌\n-7.7%', '#e74c3c'),
    ('2015-04-21', 4293, '突破4300\n杠杆牛', '#3498db'),
    ('2015-06-12', 5166, '见顶5178\n股灾开始', '#e74c3c'),
    ('2015-07-09', 3709, '国家队\n救市', '#f39c12'),
    ('2015-08-24', 3209, '811汇改\n-8.5%', '#e74c3c'),
    ('2015-08-26', 2927, '见底2850\n二次股灾', '#27ae60'),
]
...
ax1.set_title('2015年上证指数全年走势图', fontsize=18, fontweight='bold', pad=20)
...
plt.tight_layout()
plt.savefig('D:\\历史复盘\\2015\\chart_2015_index.png', dpi=150, bbox_inches='tight', facecolor='white')
print('走势图已保存: chart_2015_index.png')

# 生成月度涨跌幅图
df_monthly = pd.read_csv('c:\\Users\\Administrator\\WorkBuddy\\20260406101358\\monthly_2015.csv')
...
ax.set_title('2015年上证指数月度涨跌幅', fontsize=16, fontweight='bold', pad=15)
ax.set_ylabel('涨跌幅(%)', fontsize=12)
ax.set_xlabel('月份', fontsize=12)
ax.grid(True, alpha=0.3, axis='y')

plt.tight_layout()
plt.savefig('D:\\历史复盘\\2015\\chart_2015_monthly.png', dpi=150, bbox_inches='tight', facecolor='white')
print('月度涨跌幅图已保存: chart_2015_monthly.png')

# 生成市场情绪温度计图
months = ['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月']
sentiment = [40, 50, 65, 80, 95, 30, 15, 10, 30, 45, 50, 50]
...
ax.set_xlim(0, 105)
ax.set_title('2015年A股市场情绪温度计', fontsize=16, fontweight='bold', pad=15)
ax.set_xlabel('情绪指数', fontsize=12)
ax.grid(True, alpha=0.3, axis='x')

plt.tight_layout()
plt.savefig('D:\\历史复盘\\2015\\chart_2015_sentiment.png', dpi=150, bbox_inches='tight', facecolor='white')
print('情绪温度计图已保存: chart_2015_sentiment.png')
